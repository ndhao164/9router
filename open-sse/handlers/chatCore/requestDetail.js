...
export function saveUsageStats({ provider, model, tokens, connectionId, apiKey, endpoint, requestAttribution, label = "USAGE", silent = false }) {
  ...
  saveRequestUsage({
    ...
    requestedModel: requestAttribution?.requestedModel,
    comboName: requestAttribution?.comboName,
  }).catch(() => {});
}
